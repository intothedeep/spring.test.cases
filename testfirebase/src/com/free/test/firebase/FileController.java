package com.free.test.firebase;
...
import com.free.test.firebase.model.MemberDto;
import com.free.test.firebase.service.CommonService;
import com.free.test.firebase.service.FileService;
...
////////////////////////////////////////// upload ///////////////////////////////////////////	
	...
	public ModelAndView write(HttpSession session,
				@RequestParam("data") MultipartFile data, HttpServletRequest request) {
		...
		if(!data.isEmpty()) {
			...
			*/
			...
			if (checkIsImage (new File(storedPath, storedFileName))) {
				...
				Map <String, String> thumbMap = saveScaledImage(storedPath, storedFileName, fileseq);
	...
	private  Map<String, String> saveScaledImage(String storedPath, String storedFileName, int fileseq){
		Map<String, String> map = new HashMap<>();
